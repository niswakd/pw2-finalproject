                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default">
                    ...
                    <form action="/users" method="POST">
                        ...
                        <div class="p-6.5">
                            ...
                            <div class="mb-6">
                                <label class="mb-3 block text-sm font-medium text-black"> Fullname <span class="text-meta-1">*</span> </label>
                                <textarea
                                    id="fullname"
                                    name="fullname"
                                    rows="6"
                            ...
                            <div class="mb-6">
                                <label class="mb-3 block text-sm font-medium text-black"> Username <span class="text-meta-1">*</span> </label>
                                <textarea
                                    id="username"
                                    name="username"
                                    rows="6"
