                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default">
                    ...
                    <form enctype="multipart/form-data" action="/loans/{{ $loan->id }}" method="POST">
                        ...
                        <div class="p-6.5">
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Car Name <span class="text-meta-1">*</span> </label>
                                <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                                    ...
                                    >
                                        ...
                                        @foreach ($cars as $car)
                                            <option value="{{ $car->id }}" {{ $car->id == $loan->car_id ? 'selected' : '' }}>{{ $car->title }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Loan date <span class="text-meta-1">*</span> </label>
                                <input
                                    id="loan_date"
                                    name="loan_date"
                                    value="{{$loan->loan_date}}"
                                    type="date"
                                    placeholder="Enter loan date here"
                            ...
                            <div class="mb-4.5">
                                <label class="mb-3 block text-sm font-medium text-black"> Return date <span class="text-meta-1">*</span> </label>
                                <input
                                    id="return_date"
                                    name="return_date"
